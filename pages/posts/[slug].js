...
import {RecommendedPostCard} from "../../components/card/post";
...
export default function Post() {
    ...
    return (
        ...
        <div className="popup">
            ...
            <button className="popup-close btn btn-warning">close</button>
        </div>
            ...
            <div className="col-md-2 col-xs-12 share-center">
                <div className="share">
                    ...
                    <ul>
                        ...
                        <li>
                            <Link target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=http%3A//www.wowthemes.net">
                                <svg className="svgIcon-use" width="29" height="29" viewBox="0 0 29 29">
                    ...
                    <div className="dislike-width">
                        ...
                        <div id="d-counter">{post.disLikesCount}</div>
                    </div>
            ...
            <div className="col-md-8 col-md-offset-2 col-xs-12 mb-3">
                ...
                <div className="container text-center mt-4">
                    <span className="comment-warning">
                        Please <Link href="{% url 'account_login' %}" style={{color: "#000"}}>login</Link> to comment.
                    </span>
                </div>
                ...
                <div className="container mt-2 mb-5">
                    <div className="d-flex justify-content-center row">
                        <div className="d-flex flex-column">
                            <div
                                className="d-flex flex-row align-items-center text-left comment-top p-2 bg-white border-bottom px-4"></div>
                            <div className="coment-bottom bg-white p-2 px-4">
                                <div className="d-flex flex-row add-comment-section mt-4 mb-4">
                                    ...
                                    {/*        id="submit" {% if user.isAuthenticated == False %} disabled{% endif %}>Comment*/}
                                    {/*</button>*/}
                                </div>
                                <div id="list_comment" style={{display: "flex", flexDirection: "column"}}>
