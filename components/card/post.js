        ...
        <div className="col-xl-4 col-lg-6 col-md-6 mb-4">
            <div className="card card-custom">
                <Link href={post.url} className="post-link">
                    <Image className="card-img-top thumbnail card-img-top-custom" src={post.image} alt={post.title} />
                </Link>
                <div className="card-body card-block-custom">
                    <div className="card-block card-block-custom card-block-post-custom">
                        <div>
                            <h2 className="card-title"><Link href={post.url}>{post.title}</Link></h2>
...
export function RecommendedPostCard(post) {
    return (
        <div className="col-md-4">
            <div className="card card-custom">
                <Link href={post.url}>
                    <Image className="img-fluid img-thumb" src="{% if post.image %}{ post.image.url }{% else %}{ post.category.image.url }{% endif %}" alt=""/>
                </Link>
                <div className="card-block card-block-custom card-block-post-custom">
                    <div>
                    ...
                    <div>
                        <div className="metafooter">
                            <div className="wrapfooter">
                                                <span className="meta-footer-thumb">
                                                    <Link href={post.author.url}>
                                                        <Image className="author-thumb" src={post.author.get_image_url} alt={post.author.name } />
                                                    </Link>
                                                </span>
                                <span className="author-meta">
...
export function CategoryPostsCard(post) {
    return (
        <>
            ...
            <div className="card card-custom">
                <Link href={post.url} className="post-link">
                    <Image className="card-img-top thumbnail card-img-top-custom"
                           src="{% if post.image %}{ post.image.url }{% else %}{ post.category.image.url }{% endif %}"
                           alt="" />
                </Link>
                <div className="card-body card-block-custom">
                    <div className="card-block card-block-custom card-block-post-custom">
                        <div>
                            ...
                            <p className="card-text">{post.text_index}</p>
                        </div>
                        <div>
                            <div className="wrapfooter">
									<span className="meta-footer-thumb">
