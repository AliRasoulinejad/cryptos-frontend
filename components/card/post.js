...
export function IndexPostCard({post}) {
    ...
    const postImage = post.image !== "" ? post.image : "category_images/bitcoin-btc.png"
    return (
        <div className="col-xl-4 col-lg-6 col-md-6 mb-4">
            <div className="card card-custom">
                <Link href={postUrl} className="post-link">
                    <Image className="card-img-top thumbnail card-img-top-custom" src={`https://cryptos.blue/media/${postImage}`} alt={post.title} width={100} height={100}/>
                </Link>
                        ...
                        <div>
                            <div className="wrapfooter">
                                ...
                                <span className="author-meta">
                                    ...
                                    <br/>
                                    <span className="post-date" created_at={`${post.createdAt}`}>{post.createdAt}</span>
...
export function RecommendedPostCard({post}) {
    ...
    return (
        <div className="col-md-4">
            <div className="card card-custom">
                <Link href={postUrl}>
                    <Image className="img-fluid img-thumb" src={`https://cryptos.blue/media/${postImage}`} alt="" width={100} height={100}/>
                </Link>
                <div className="card-block card-block-custom card-block-post-custom">
                    <div>
...
export function CategoryPostsCard({post, defaultImage}) {
    const postUrl = `posts/${post.conversationID}`
